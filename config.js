...
const AIVOICE_DETAIL_GET_PATH = '/api/config/get/aivoice/detail';
const AIVOICE_DETAIL_UPDATE_PATH = '/api/config/update/aivoice/detail';
const AIVOICE_REVIEW_UPDATE_AUTH_ID = process.env.AIVOICE_REVIEW_UPDATE_AUTH_ID || 'YjY4M2VlM2MtMGU5ZS00Y2MxLWI2OWEtYmM2ZmQ0';
const AIVOICE_REVIEW_UPDATE_BEARER = process.env.AIVOICE_REVIEW_UPDATE_BEARER || 'U0FNTVEzWkpJME5KRk1ZWkxNTlo6WWpZNE0yVmxNMk10TUdVNVpTMDBZMk14TFdJMk9XRXRZbU0yWm1RMA==';
...
module.exports = {
  ...
  OPENAI_API_KEY,
  TXQL_API_URL,
  AIVOICE_DETAIL_GET_PATH,
  AIVOICE_DETAIL_UPDATE_PATH,
  AIVOICE_REVIEW_UPDATE_AUTH_ID,
  AIVOICE_REVIEW_UPDATE_BEARER,
  DISPLAY_CONFIG,
  TIMEZONE,
  PORT,
